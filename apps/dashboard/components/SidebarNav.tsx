...
const groups:NavGroup[]=[
  ...
  {label:'SUPPORT',items:[{name:'Issues',href:'/issues',permission:'issues.view'},{name:'Suggestions',disabled:'soon',permission:'suggestions.view'},{name:'Moderation',href:'/moderation',permission:'moderation.view'}]},
