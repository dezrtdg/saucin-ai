...
type Counts={automation:number;tickets:number;issues:number;suggestions:number;knowledgeGaps:number;moderation:number;txadmin:number;personal:number};
...
const emptyCounts:Counts={automation:0,tickets:0,issues:0,suggestions:0,knowledgeGaps:0,moderation:0,txadmin:0,personal:0};
