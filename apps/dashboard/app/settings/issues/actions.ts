...
export async function createIssueCategoryAction(formData: FormData) {
  return runDashboardAction({fallbackPath:'/settings/issues',successMessage:'Issue category created.'},async()=>{
...
export async function updateIssueCategoryAction(key: string, formData: FormData) {
  return runDashboardAction({fallbackPath:'/settings/issues',successMessage:'Issue category saved.'},async()=>{
...
export async function deleteIssueCategoryAction(key: string) {
  return runDashboardAction({fallbackPath:'/settings/issues',successMessage:'Issue category deleted.'},async()=>{
...
export async function updateIssueAutomationAction(formData: FormData) {
  return runDashboardAction({fallbackPath:'/settings/issues',successMessage:'Issue automation settings saved.'},async()=>{
...
export async function updateIssueTemplateAction(status: string, formData: FormData) {
  return runDashboardAction({fallbackPath:'/settings/issues',successMessage:'Issue response template saved.'},async()=>{
