...
const moduleCatalog:Record<AutomationModuleKey,{
  ...
  tickets:{label:'Private tickets',permission:'tickets.view',maxLevel:'auto_safe',summary:'Routes support work and surfaces unclaimed tickets.',safeActions:'Organize, summarize, send configured follow-up reminders, and retry failed reminder deliveries.',humanBoundary:'Claiming, releasing, status changes, closing, punishments, reversals, and sensitive staff decisions remain human-controlled.',settingsHref:'/settings/tickets'},
